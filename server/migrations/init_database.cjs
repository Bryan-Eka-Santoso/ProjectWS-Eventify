...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('users', {
      ...
      role: { type: Sequelize.ENUM('admin', 'organizer', 'user'), allowNull: false },
    ...
    await queryInterface.createTable('organizer_applications', {
      ...
      organizer_name: { type: Sequelize.STRING(255), allowNull: false, comment: 'Nama event organizer / perusahaan' },
      ktp_number: { type: Sequelize.STRING(50), allowNull: false, comment: 'Nomor KTP penanggung jawab' },
      ktp_image_url: { type: Sequelize.STRING(255), allowNull: false, comment: 'URL file foto KTP' },
      phone_number: { type: Sequelize.STRING(50), allowNull: false },
      address: { type: Sequelize.TEXT, allowNull: false },
      social_media_link: { type: Sequelize.STRING(255), allowNull: true, comment: 'Opsional untuk mengecek portofolio' },
      status: { type: Sequelize.ENUM('pending', 'approved', 'rejected'), defaultValue: 'pending' },
      rejection_reason: { type: Sequelize.TEXT, allowNull: true, comment: 'Diisi admin jika pendaftaran ditolak' },
      created_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updated_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP') }
    });
    ...
    await queryInterface.createTable('follows', {
      id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      follower_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
      following_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
      created_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') }
    });
    ...
    await queryInterface.createTable('events', {
      ...
      status: { type: Sequelize.ENUM('draft', 'pending_approval', 'published', 'rejected', 'canceled', 'completed'), defaultValue: 'draft' },
      rejection_reason: { type: Sequelize.TEXT, allowNull: true, comment: 'Alasan dari admin jika event ditolak' },
    ...
    await queryInterface.createTable('event_categories', {
      event_id: { type: Sequelize.INTEGER, allowNull: false, primaryKey: true, references: { model: 'events', key: 'id' }, onDelete: 'CASCADE' },
      category_id: { type: Sequelize.INTEGER, allowNull: false, primaryKey: true, references: { model: 'categories', key: 'id' }, onDelete: 'CASCADE' }
    });
    ...
    await queryInterface.createTable('ticket_types', {
      ...
      name: { type: Sequelize.STRING(100), allowNull: false, comment: 'Contoh: VIP, Regular, Early Bird' },
    ...
    await queryInterface.createTable('user_vouchers', {
      id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      user_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
      voucher_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'vouchers', key: 'id' }, onDelete: 'CASCADE' },
      is_used: { type: Sequelize.BOOLEAN, defaultValue: false },
      claimed_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    ...
    await queryInterface.createTable('transactions', {
      id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      user_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
      user_voucher_id: { type: Sequelize.INTEGER, allowNull: true, references: { model: 'user_vouchers', key: 'id' }, onDelete: 'SET NULL' },
      ...
      payment_status: { type: Sequelize.ENUM('pending', 'paid', 'expired', 'failed'), defaultValue: 'pending' },
      payment_method: { type: Sequelize.STRING(100), allowNull: true },
      refund_status: { type: Sequelize.ENUM('none', 'requested', 'refunded', 'rejected'), defaultValue: 'none' },
      created_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updated_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP') }
    });
    ...
    await queryInterface.createTable('transaction_details', {
      id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      transaction_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'transactions', key: 'id' }, onDelete: 'CASCADE' },
      ticket_type_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'ticket_types', key: 'id' }, onDelete: 'CASCADE' },
    ...
    await queryInterface.createTable('user_tickets', {
      ...
      user_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
      ticket_type_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'ticket_types', key: 'id' }, onDelete: 'CASCADE' },
      transaction_detail_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'transaction_details', key: 'id' }, onDelete: 'CASCADE' },
      ticket_code: { type: Sequelize.STRING(255), unique: true, allowNull: false },
      status: { type: Sequelize.ENUM('active', 'used', 'refunded'), defaultValue: 'active' },
      created_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') }
    });
    ...
    await queryInterface.createTable('chat_room_members', {
      id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      chat_room_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'chat_rooms', key: 'id' }, onDelete: 'CASCADE' },
      user_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
    ...
    await queryInterface.createTable('messages', {
      ...
      message_type: { type: Sequelize.ENUM('text', 'image', 'video', 'recommendation'), defaultValue: 'text' },
      body: { type: Sequelize.TEXT, allowNull: true },
      media_url: { type: Sequelize.STRING(255), allowNull: true },
      recommended_event_id: { type: Sequelize.INTEGER, allowNull: true, references: { model: 'events', key: 'id' }, onDelete: 'SET NULL' },
      created_at: { type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') }
    });
  },
